...
impl ListCommand {
    ...
    async fn list_all_documents(&self, repo: &mut metis_core::dal::database::repository::DocumentRepository) -> MetisResult<Vec<metis_core::dal::database::models::Document>> {
    ...
    fn display_documents(&self, documents: &[metis_core::dal::database::models::Document]) {
        println!("\n{:<15} {:<30} {:<15} {:<15} {:<20}", "TYPE", "TITLE", "PHASE", "ID", "UPDATED");
        println!("{}", "-".repeat(95));
